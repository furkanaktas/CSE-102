...
/***************************	LECT(dersler)	******************/		
	...
	for(i=0;i< miktar;i++)
	{
		printf("%d ",lect[i].code);
		printf("%s ",lect[i].name);
		printf("%d \n",lect[i].idOfLect);
	}
/***************************	SCHEDUL(takvim)	******************/		
	...
	for(i=0;i< miktar;i++)
	{
		printf("%s ",schedul[i].class);
		printf("%s ",schedul[i].day);
		printf("%d ",schedul[i].start);
		printf("%d ",schedul[i].time);
		printf("%d \n",schedul[i].code);
	}
